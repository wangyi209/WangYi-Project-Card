const userID = "1093501044740325417";
const elements = {
...
function startWebSocket() {
	...
	ws.onmessage = (event) => {
		...
		if (t === "INIT_STATE" || t === "PRESENCE_UPDATE") {
			...
			if (!d || !d.discord_user || !d.discord_status || !d.activities) {
				console.error("Dữ liệu không hợp lệ:", d);
				return;
			}
			// Cập nhật trạng thái nếu dữ liệu hợp lệ
			console.log("Cập nhật trạng thái:", d);
			updateStatus(d);
		}
	};
	ws.onerror = (error) => {
